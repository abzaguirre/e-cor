...
<div class="content">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a class = "text-info" href="<?= base_url() ?>transactions/">Transactions</a></li>
    ...
    <div class = "row">
        <div class="col-md-12">
            <div class = "card">
                ...
                <div class = "card-body">
                    <center>
                        <h1><?= $fetched_transaction[0]->client_firstname . " " . $fetched_transaction[0]->client_lastname ?></h1>
                        <!--<img class = "img-fluid" width = "50" src = "<?= base_url() . $fetched_transaction[0]->client_picture ?>" >-->
                        <div class = "image-fit">
                            <a href = "<?= base_url() . $fetched_transaction[0]->client_picture ?>" data-toggle="lightbox">
                                <img class="d-flex mx-auto" src="<?= base_url() . $fetched_transaction[0]->client_picture ?>"  style = "height:128px; width:128px;" alt = "">
                            </a>
                        </div>
                        <br/>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-6">
                            <div class = "card">
                                ...
                                <div class = "card-body">
                                    <strong><?= $fetched_transaction[0]->packages_name; ?></strong>
                                </div>
                                <?php $total_price = 0; ?>
                                <?php $items = $this->Packages_model->get_item_in_packages(array("item.packages_id" => $fetched_transaction[0]->packages_id)); ?>
                                <?php if (!empty($items)): ?>
                    ...
                    <center>
                        ...
                        <i class = "text-muted"><?= $fetched_transaction[0]->transaction_notes == ""? "NONE" : $fetched_transaction[0]->transaction_notes?></i>
                    </center>
                    <center class = "mt-5">
                        <h5>Schedule</h5>
                        <i class = "text-muted"><?= date("F d, Y - h:i A", $fetched_transaction[0]->schedule_startdate); ?></i>
                    </center>
                    <center class = "mt-5">
                    ...
                    <center class = "mt-5">
                        <h5>Reserved at</h5>
                        <i class = "text-muted"><?= date("F d, Y - h:i A", $fetched_transaction[0]->transaction_added_at); ?></i>
                    </center>
                </div>
            </div>
        </div>
