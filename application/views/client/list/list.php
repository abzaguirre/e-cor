    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header" style="background:rgba(160,160,160,0.3); height:60px;">
                ...
                <span style="color:grey; font-size:20px;"><i class="fa fa-user"></i> Event Planners</span>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <?php if (empty($ep)): ?>
                        <div class = "col-lg-12">
                            <center>
                                <h4>There are no available Event Planners for this event.</h4>
                        ...
                        <?php foreach ($ep as $eps): ?>
                            ...
                            <div class="col-md-3">
                                <div class="card text-center">
                                    <img src="<?= base_url() . $eps->event_planner_picture ?>" class="img-fluid card-img-top"  style="height:200px !important;" />
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href = "<?= base_url() ?>ClientReservation/packages_exec/<?= $eps->event_planner_id; ?>/<?= $schedule_id ?>" class = "btn btn-outline-primary btn-md pull-right" title="Choose Event Planner"><i class = "fa fa-hand-o-up"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Modal Detail -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class ="col-md-5">
                                                    <div class="card text-center">
                                                        <img src = "<?= base_url() . $eps->event_planner_picture ?>" class = "img-fluid"/>
                                                        <div class="card-body">
                                                            <div class="star-rating">
                                                                <?= getRatings($percent) ?>
                                                            </div>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <?php foreach ($remarks as $remark): ?>
                                                                ...
                                                                <div class="card-body small bg-faded">    
                                                                    <div class="media">
                                                                        <div class = "image-fit">
                                                                            <img class="d-flex mr-3" style = "height:40px; width:50px;" src="<?= base_url() . $remark->client_picture ?>" alt="">
                                                                        </div>
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <div class="star-rating text-muted">
                                                                                <?= getRatings($remark->rating_percentage) ?>
                                                                            </div>
                                                                            <div class = "my-2">
