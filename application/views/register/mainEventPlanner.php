    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8" style="margin-top:-100px;">
                ...
                <form class="form" action="<?= base_url() ?>register/registerEventPlanner_submit" method="POST">
                    ...
                    <div class="form-group">
                        <textarea class="form-control <?= !empty(form_error("intro")) ? "is-invalid" : ""; ?>" id="exampleTextarea" name = "intro" rows="3" placeholder="Your Introduction"></textarea>
                        <div class="invalid-feedback"><?= form_error('intro') ?></div>
                    </div>
                    <div class="form-group">
                        <input class="form-control <?= !empty(form_error("tin")) ? "is-invalid" : ""; ?>" type="text" name="tin" placeholder = "Tin Number e.g(123-456-789-321)" value = "<?= set_value("tin") ?>"/>
                        <div class="invalid-feedback"><?= form_error('tin') ?></div>
                    </div>
                    <div class="form-group">
                        <div class ="mx-auto">
                            <?= $widget ?>
