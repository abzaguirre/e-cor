...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
        ...
        <div class="main">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                            <div class="alt-services-image align-center"><img src="<?= base_url() ?>assets/main/images/promo.png" alt="Feature Image"></div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="alt-features-item">
            ...
            <section class="module bg-dark-60" data-background="<?= base_url() ?>assets/main/images/section-6.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="video-box">
            ...
            <section class="module pb-0" id="works">
                ...
                <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid">
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio1.jpg" alt="Portfolio Item"/></div>
                    ...
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio2.jpg" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio3.jpg" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio4.jpg" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio5.jpg" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                    ...
                    <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                            <div class="work-image"><img src="<?= base_url() ?>assets/main/images/portfolio/grid-portfolio6.jpg" alt="Portfolio Item"/></div>
                            <div class="work-caption font-alt">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                            <div class="team-item">
                                <div class="team-image"><img src="<?= base_url() ?>assets/main/images/team-1.jpg" alt="Member Photo"/>
                        ...
                        <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                            <div class="team-item">
                                <div class="team-image"><img src="<?= base_url() ?>assets/main/images/team-2.jpg" alt="Member Photo"/>
                                    <div class="team-detail">
                        ...
                        <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                            <div class="team-item">
                                <div class="team-image"><img src="<?= base_url() ?>assets/main/images/team-3.jpg" alt="Member Photo"/>
                                    <div class="team-detail">
                        ...
                        <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                            <div class="team-item">
                                <div class="team-image"><img src="<?= base_url() ?>assets/main/images/team-4.jpg" alt="Member Photo"/>
                                    <div class="team-detail">
                    ...
                    <div class="row multi-columns-row post-columns">
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            <div class="post mb-20">
                                <div class="post-thumbnail"><a href="#"><img src="<?= base_url() ?>assets/main/images/post-1.jpg" alt="Blog-post Thumbnail"/></a></div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            <div class="post mb-20">
                                <div class="post-thumbnail"><a href="#"><img src="<?= base_url() ?>assets/main/images/post-2.jpg" alt="Blog-post Thumbnail"/></a></div>
                                <div class="post-header font-alt">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            <div class="post mb-20">
                                <div class="post-thumbnail"><a href="#"><img src="<?= base_url() ?>assets/main/images/post-3.jpg" alt="Blog-post Thumbnail"/></a></div>
                                <div class="post-header font-alt">
                        ...
                        <div class="col-sm-3">
                            <div class="widget">
                                ...
                                <ul class="widget-posts">
                                    <li class="clearfix">
                                        <div class="widget-posts-image"><a href="#"><img src="<?= base_url() ?>assets/main/images/rp-1.jpg" alt="Post Thumbnail"/></a></div>
                                    ...
                                    <li class="clearfix">
                                        <div class="widget-posts-image"><a href="#"><img src="<?= base_url() ?>assets/main//images/rp-2.jpg" alt="Post Thumbnail"/></a></div>
                                        <div class="widget-posts-body">
